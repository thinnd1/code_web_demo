            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-6" style="padding-top: 21px; padding-left: 585px;" >
                        <a href="{{ route('viewcreateproduct') }}" class="btn btn-info">Tao moi</a>
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            @foreach ($products as $index =>$product)
                                <tr>
                                    ...
                                    <td>{{ $product->vote }}</td>
                                    <td>
                                        <a class="btn btn-danger" href="{{ route('deleteproduct', ['id' => $product->id ]) }}">Xóa</a>
                                        <a class="btn btn-warning" href="{{ route('vieweditproduct', ['id' => $product->id ]) }}">Sửa</a>
                                    </td>
                                </tr>
                                @endforeach
                                @endif
