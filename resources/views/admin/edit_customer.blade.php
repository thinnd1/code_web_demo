            ...
            <div class="col-lg-9">
                <form action="{{ route('editcustomer', ['id' => $user->id]) }}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="username" class="form-control" value="" id="inputUser">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputFullName" class="col-sm-2 col-form-label">Họ Và Tên*</label>
                        <div class="col-sm-10">
                            <input type="text" name="full_name" class="form-control" value="" id="inputFullName">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" name="age" value="" class="form-control" id="inputAge">
                        </div>
                    </div>
                    <div class="form-group row">
