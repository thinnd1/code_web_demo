        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <form action="">
                        <div class="col-lg-6">
                            <input type="text" name="search_company" class="form-control" placeholder="Tìm theo tên, email, số điện thoại ... " value="{{ request()->input('search_company', old('search_company')) }}" id="inputname">
                        </div>
                        <div class="col-lg-6">
